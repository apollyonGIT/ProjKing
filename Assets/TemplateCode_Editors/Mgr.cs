...
namespace Editor.AutoCreators
{
    public class Mgr
    {
        static string path = "Assets/TemplateCode_Editors/Templates/Mgr_Template.cs.txt";

        //==================================================================================================

        [MenuItem("Assets/TemplateCode/Mgr", false, -1)]
        ...
        {
            return $"{Cell.create_file_name(folder_name)}Mgr";
        }
